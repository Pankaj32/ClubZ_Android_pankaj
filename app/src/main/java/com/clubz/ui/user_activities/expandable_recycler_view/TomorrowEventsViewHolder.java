...
public class TomorrowEventsViewHolder extends ChildViewHolder {
    ...
    public void bind(final GetActivitiesResponce.DataBean.TomorrowBean.EventsBeanX events, final int childPos, final ChildViewClickListioner childViewClickListioner) {
