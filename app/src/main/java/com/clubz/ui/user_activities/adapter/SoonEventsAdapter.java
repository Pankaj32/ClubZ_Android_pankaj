...
public class SoonEventsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private String mType;
    private List<GetOthersActivitiesResponce.DataBean.SoonBean.EventsBeanXX> soonEventsBeans;
    private EventItemClickListioner eventItemClickListioner;

    public SoonEventsAdapter(Context context,/*String type,*/List<GetOthersActivitiesResponce.DataBean.SoonBean.EventsBeanXX> soonEventsBeans,EventItemClickListioner eventItemClickListioner) {
        this.context = context;
        // this.mType = type;
        this.soonEventsBeans = soonEventsBeans;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        SoonEventsAdapter.MyViewHolder h = (SoonEventsAdapter.MyViewHolder) holder;
        GetOthersActivitiesResponce.DataBean.SoonBean.EventsBeanXX eventsBean = soonEventsBeans.get(position);
