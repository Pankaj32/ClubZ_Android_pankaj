...
class ReceiptAdapter(val context: Context, val listner: Listner) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_receipt, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        }else holder.bottomView.visibility = View.VISIBLE
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val bottomView = view.bottomView!!
