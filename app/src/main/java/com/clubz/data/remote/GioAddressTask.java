...
public abstract class GioAddressTask extends AsyncTask<Void, Void, Void> {
    ...
    public interface LocationListner{
        void onSuccess(com.clubz.data.model.Address address);
    }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if(address!=null){
            com.clubz.data.model.Address adr = new com.clubz.data.model.Address();
   ...
   public abstract void onSuccess(com.clubz.data.model.Address address);
}
